return {
  ...
  require = { "nvim-telescope/telescope-fzf-native.nvim" },
  branch = "0.1.x",
  config = function()
    ...
    map("n", "<leader>F", builtin.find_files, {})       -- Lists files in your current working directory, respects .gitignore
    ...
    map("n", "<leader>fg", builtin.live_grep, opts)     -- Lists spell options
  end
}
